...
function Solarinstallation() {
    return (
        <div className='solarinstallation-container'>
            <div className='solarinstallation-head'>
            ...
            <h2 className='solarinstallation-heading'>1. Solar Installation</h2>
            ...
            <div className='solarinstallation-section'>
                ...
                <div className='solarinstallation-description'>
                    ...
                    <div className="solar-services-intro">
                    ...
                    <div className="solar-services-list">
                        ...
                        <ul className="solar-services-items">
                            <li className="solar-service-item">
                                <span className="service-title">1. On-Grid Systems:</span> Perfect for locations with a reliable grid connection, It generates electricity from solar panels and can draw power from the grid when
            ...
            <h2 className='solarinstallation-heading'>2. Battery storage solutions</h2>
            <div className='solarinstallation-section'>
                ...
                <div className='solarinstallation-description'>
                    ...
                    <div className="solar-services-list">
                        ...
                        <ul className="solar-services-items">
                            <li className="solar-service-item">
                                <span className="service-title">1. Advanced Battery Storage Systems:</span> We offer cutting-edge lithium-ion and leadacid battery systems from three leading brands.
                            </li>
                            <li className="solar-service-item">
                                <span className="service-title">2. Energy Optimization & Management:</span>Our smart energy management systems
                            ...
                            <li className="solar-service-item">
                                <span className="service-title">3.Grid-Tied and Off-Grid Solutions </span> Whether you are connected to the grid or looking
            ...
            <h2 className='solarinstallation-heading'>3. Consultation And Site Assessments</h2>
            <div className='solarinstallation-section'>
                ...
                <div className='solarinstallation-description'>
                    ...
                    <div className="solar-services-list">
                        ...
                        <ul className="solar-services-items">
                            <li className="solar-service-item">
                                <span className="service-title">1. Site Assessment and Consultation:</span> A representative from DT Energy visits the
                            ...
                            <li className="solar-service-item">
                                <span className="service-title">2.Structural Analysis</span></li>
                            <li className="solar-service-item">
                                <span className="service-title">3.Energy Production Estimates</span> Whether you are connected to the grid or looking
                                for complete energy independence, we have the right storage solution for you. </li>
                            <li className="solar-service-item">
                                <span className="service-title">4.System design,permits & paper works</span>Before proceeding with installation, DT Energy obtains the
                                necessary permits from local authorities </li>
                            <li className="solar-service-item">
                                <span className="service-title">5.Installation of Solar Panels & Electrical wiring:</span>Before proceeding with installation, DT Energy obtains the
                                necessary permits from local authorities </li>
                            <li className="solar-service-item">
                                <span className="service-title">6.System Inspection,Approval & Connecting to the Grid </span></li>
                            <li className="solar-service-item">
                                <span className="service-title">7.Commissioning and Activation</span></li>
            ...
            <h2 className='solarinstallation-heading'>4. Financial Assistance</h2>
            <div className='client-need'>
            ...
            <div className='solarinstallation-section'>
                ...
                <div className='solarinstallation-description'>
                    ...
                    <div className="solar-services-list">
                        ...
                        <ul className="solar-services-items">
                            <li className="solar-service-item">
                                <span className="service-title">1. Solar Loans:</span> Our solar loans are specifically designed to help homeowners and
